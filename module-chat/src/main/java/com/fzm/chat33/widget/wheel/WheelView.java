...
import com.fzm.chat33.widget.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.color.chat_white;
...
//		paint.setColor(ContextCompat.getColor(getContext(), R.color.province_line_border));
//		// 设置线宽
