package com.fzm.chat33.widget.xcpulltoloadmorelistview;
...
public class RefreshHeader extends LinearLayout {
    ...
    private String[] mTxtStatus = Chat33.getContext().getResources().getStringArray(R.array.chat_refresh_header);
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mHeaderHeight = ScreenUtils.dp2px(context, 50);
        //初始化自己
        ...
        this.setBackgroundColor(ContextCompat.getColor(context, R.color.bg_pull_header));

        //add progress view
        mProgressView = new ProgressView(context);
        LayoutParams lp2 = new LayoutParams(
                ScreenUtils.dp2px(context, 25), ScreenUtils.dp2px(context, 25));
        ...
        LayoutParams lp = new LayoutParams(
                ScreenUtils.dp2px(context, 20), ScreenUtils.dp2px(context, 20));
        ...
        lp = new LayoutParams(
                ScreenUtils.dp2px(context, 100), LayoutParams.WRAP_CONTENT);
        lp.gravity = Gravity.BOTTOM;
        lp.leftMargin = ScreenUtils.dp2px(context, 5);
