...
/**
 * Created by zhengjy on 2017/7/7.
 *
 * switchView with iOS style.
 */
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = AppConfig.APP_ACCENT_COLOR_INT;
    private final int DEFAULT_COLOR_PRIMARY_DARK = AppConfig.APP_ACCENT_COLOR_INT;
