...
//        degreeSingleDelta = mOrientation.computeDegreeSingleDelta(diSingleMoveX, diSingleMoveY, radius);
    ...
    protected void onTouchDown(MotionEvent event) {
        if(onWheelTouchDownListener != null) {
            onWheelTouchDownListener.onWheelTouchDown(event);
        }
    }

    public OnWheelTouchDownListener onWheelTouchDownListener;

    public void setOnWheelTouchDownListener(OnWheelTouchDownListener onWheelTouchDownListener) {
        this.onWheelTouchDownListener = onWheelTouchDownListener;
    }

    public interface OnWheelTouchDownListener {
        void onWheelTouchDown(MotionEvent event);
    }
}