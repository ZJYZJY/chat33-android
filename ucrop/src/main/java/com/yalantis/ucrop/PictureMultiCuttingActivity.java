...
public class PictureMultiCuttingActivity extends AppCompatActivity {
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setDimmedColor(intent.getIntExtra(UCropMulti.Options.EXTRA_DIMMED_LAYER_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_default_dimmed)));
        ...
        mOverlayView.setCropFrameColor(intent.getIntExtra(UCropMulti.Options.EXTRA_CROP_FRAME_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_default_crop_frame)));
        ...
        mOverlayView.setCropGridColor(intent.getIntExtra(UCropMulti.Options.EXTRA_CROP_GRID_COLOR, ContextCompat.getColor(this, R.color.ucrop_color_default_crop_grid)));
