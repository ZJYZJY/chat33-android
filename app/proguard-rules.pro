...
-keepclasseswithmembers class * extends com.fzm.chat33.core.response.BaseResponse{*;}

-keepclasseswithmembers class * extends com.fzm.chat33.core.request.BaseRequest{*;}

-keepclasseswithmembers class * extends com.fuzamei.componentservice.event.BaseEvent {*;}

-keep public class com.fzm.chat33.bean.**{ *;}
-keep public class com.fzm.chat33.core.bean.**{ *;}
-keep public class com.fzm.chat33.core.db.bean.**{ *;}
-keep public class com.fzm.chat33.core.event.**{ *;}
...
-keepclasseswithmembers class * extends com.fzm.framework.response.BaseResponse{
*;
}
...
# 图形验证码
#-libraryjars libs/VerifySDK.jar
