...
public class EssFile implements Parcelable {
    ...
    private String childFolderCount = FzmFramework.getString(R.string.file_picker_loading);
    private String childFileCount = FzmFramework.getString(R.string.file_picker_loading);
