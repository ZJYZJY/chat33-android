...
//        EventBus.getDefault().register(this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mCountMenuItem.setTitle(String.format(getString(R.string.file_picker_selected_file_count), String.valueOf(mSelectedFileList.size()), String.valueOf(mMaxCount)));
        return true;
    }
