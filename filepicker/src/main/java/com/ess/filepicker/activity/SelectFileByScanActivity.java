...
public class SelectFileByScanActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initUi() {
        ...
        getSupportActionBar().setTitle(R.string.file_picker_select_file_title);
    ...
    public void onFragSelectFile(FileScanFragEvent event) {
        ...
        mCountMenuItem.setTitle(String.format(getString(R.string.file_picker_selected_file_count), String.valueOf(mSelectedFileList.size()), String.valueOf(SelectOptions.getInstance().maxCount)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.browser_select_count) {
            ...
            new AlertDialog
                    .Builder(this)
                    .setSingleChoiceItems(R.array.file_picker_sort_list_scan, 0, new DialogInterface.OnClickListener() {
                        @Override
